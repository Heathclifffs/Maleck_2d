...
- Animations nerveuses : IDLE_FPS=24, WALK_FPS=30, RUN_FPS=70, COMBAT_IDLE_FPS=24, RUNNING_JUMP_FPS=70, SLIDE_FPS=70
...
- `art/riale/` — spritesheets Riale (idle, walk, run, combat_idle, running_jump, running_slide)
