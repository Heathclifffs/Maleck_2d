#!/usr/bin/env python3
"""Generate Ouda run spritesheets (8 directions) from sources + mirroring."""

from PIL import Image
import numpy as np
import os

SRC = "/home/yipene/Documents/Projects/artworks/Maleck/Ouda/anim/run"
DST = "/home/yipene/Documents/Projects/artworks/Maleck/game/art/ouda/run"
TARGET_FEET_Y = 344
CELL_W = 768
CELL_H = 448
ROWS = 8
...
SOURCES = {
    "down": "ouda_run_down.png",
    "down_right": "ouda_run_down-right.png",
    "right": "ouda_run_right.png",
    "up": "ouda_run_up.png",
    "up_right": "ouda_run_up-right.png",
}
...
def process_direction(dir_name, img):
    ...
    dst_path = os.path.join(DST, f"{dir_name}_run.png")
...
def main():
    ...
    for d in ["down", "down_left", "left", "up_left", "up", "up_right", "right", "down_right"]:
        p = os.path.join(DST, f"{d}_run.png")
        if os.path.exists(p):
