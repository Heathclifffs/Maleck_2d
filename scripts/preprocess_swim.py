#!/usr/bin/env python3
"""Generate Riale swim spritesheets (8 directions) from 5 sources + mirroring."""

from PIL import Image
import numpy as np
import os

SRC = "/home/yipene/Documents/Projects/artworks/Maleck/Riale/anim/swim"
DST = "/home/yipene/Documents/Projects/artworks/Maleck/game/art/riale/swim"
TARGET_FEET_Y = 344
CELL_W = 768
CELL_H = 448
ROWS = 8
...
TARGET_H = {
    "down": 130, "down_left": 120, "down_right": 120,
    "left": 130, "right": 130,
    "up": 130, "up_left": 120, "up_right": 120,
}

SOURCES = {
    "down":       "riale_swim_down.png",
    "down_right": "riale_swim_down-right.png",
    "right":      "riale_swim_right.png",
    "up_right":   "riale_swim_up-right.png",
    "up":         "riale_swim_up.png",
}
...
def process_direction(dir_name, img):
    ...
    dst_path = os.path.join(DST, f"{dir_name}_swim.png")
...
def main():
    ...
    for d in ["down", "down_left", "left", "up_left", "up", "up_right", "right", "down_right"]:
        p = os.path.join(DST, f"{d}_swim.png")
        if os.path.exists(p):
