#!/usr/bin/env python3
"""Generate Riale taken-damage spritesheets (8 directions) from 5 sources + mirroring."""

from PIL import Image
import numpy as np
import os

SRC = "/home/yipene/Documents/Projects/artworks/Maleck/Riale/anim/taken_damage"
DST = "/home/yipene/Documents/Projects/artworks/Maleck/game/art/riale/taken_damage"
TARGET_FEET_Y = 344
CELL_W = 768
CELL_H = 448
ROWS = 8
...
TARGET_H = {
    "down": 215, "down_left": 200, "down_right": 200,
    "left": 215, "right": 215,
    "up": 215, "up_left": 200, "up_right": 200,
}

SOURCES = {
    "down":       "riale_taken-damage_down.png",
    "down_right": "riale_taken-damage_down-right.png",
    "right":      "riale_taken-damage_right.png",
    "up_right":   "riale_taken-damage_up-right.png",
    "up":         "riale_taken-damage_up.png",
}
...
def process_direction(dir_name, img):
    ...
    dst_path = os.path.join(DST, f"{dir_name}_taken_damage.png")
    target_h = TARGET_H.get(dir_name, 215)
    print(f"  {dir_name:15s} target_h={target_h}...")
...
def main():
    ...
    print("\nTaken-damage spritesheets:")
    for d in ["down", "down_left", "left", "up_left", "up", "up_right", "right", "down_right"]:
        p = os.path.join(DST, f"{d}_taken_damage.png")
        if os.path.exists(p):
