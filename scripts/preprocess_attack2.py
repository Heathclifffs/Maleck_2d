#!/usr/bin/env python3
"""Generate Riale attack2 spritesheets (8 directions) from 5 sources + mirroring."""

from PIL import Image
import numpy as np
import os

SRC = "/home/yipene/Documents/Projects/artworks/Maleck/Riale/anim/combat/attack2"
DST = "/home/yipene/Documents/Projects/artworks/Maleck/game/art/riale/attack2"
TARGET_FEET_Y = 344
CELL_W = 768
CELL_H = 448
ROWS = 8
...
SOURCES = {
    "down":       "riale_attack_2_down.png",
    "down_right": "riale_attack_2_down_right.png",
    "right":      "riale_attack_2_right.png",
    "up_right":   "riale_attack_2_up_right.png",
    "up":         "riale_attack_2_up.png",
}
...
def process_direction(dir_name, img):
    ...
    dst_path = os.path.join(DST, f"{dir_name}_attack2.png")
...
def main():
    ...
    for d in ["down", "down_left", "left", "up_left", "up", "up_right", "right", "down_right"]:
        p = os.path.join(DST, f"{d}_attack2.png")
        if os.path.exists(p):
