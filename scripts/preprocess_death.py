#!/usr/bin/env python3
"""Generate Riale death spritesheets (8 directions) from 5 sources + mirroring."""

from PIL import Image
import numpy as np
import os

SRC = "/home/yipene/Documents/Projects/artworks/Maleck/Riale/anim/death"
DST = "/home/yipene/Documents/Projects/artworks/Maleck/game/art/riale/death"
TARGET_FEET_Y = 344
CELL_W = 768
CELL_H = 448
ROWS = 8
...
SOURCES = {
    "down":       "riale_death_down.png",
    "down_right": "riale_death_dow-right.png",
    "right":      "riale_death_right.png",
    "up_right":   "riale_death_up-right.png",
    "up":         "riale_death_up.png",
}
...
def process_direction(dir_name, img):
    ...
    dst_path = os.path.join(DST, f"{dir_name}_death.png")
...
def main():
    ...
    for d in ["down", "down_left", "left", "up_left", "up", "up_right", "right", "down_right"]:
        p = os.path.join(DST, f"{d}_death.png")
        if os.path.exists(p):
